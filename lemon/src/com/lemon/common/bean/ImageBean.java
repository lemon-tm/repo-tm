...
public class ImageBean implements Comparable<ImageBean> {
	...
	public static final String UPLOAD_PATH = "/image/upload";
	...
	public boolean equals(Object object) {
		...
		if (object instanceof ImageBean) {
			ImageBean truthImage = (ImageBean) object;
			if (this.getId() == null || truthImage.getId() == null) {
				return false;
			} else {
				return (this.getId().equals(truthImage.getId()));
			}
		}
		return false;
	}
	...
	public int compareTo(ImageBean truthImage) {
		if (truthImage.getOrderList() == null) {
			return 1;
		}
		if (this.getOrderList() == null) {
			return -1;
		}
		return this.getOrderList().compareTo(truthImage.getOrderList());
	}
