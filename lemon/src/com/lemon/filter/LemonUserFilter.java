 ...
 * UserFilter
 */
public class LemonUserFilter extends UserFilter {
	//未登录重定向到登陆页
	protected void redirectToLogin(ServletRequest req, ServletResponse resp)
		...
		}else if(request.getRequestURI().startsWith(request.getContextPath() + "/bcollegemember")){
			loginUrl = "/bcollegemember/login.jspx";
		}else {
